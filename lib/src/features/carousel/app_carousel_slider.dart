...
import 'app_carousel_option.dart';
import 'app_carousel_state.dart';
...
class AppCarouselSlider extends StatefulWidget {
  ...
  final AppCarouselOptions options;
  ...
  final AppCarouselControllerImpl _carouselController;
  ...
  AppCarouselSlider(
      ...
      this.disableGesture,
      AppCarouselController? carouselController,
      Key? key})
      : itemBuilder = null,
        itemCount = items != null ? items.length : 0,
        _carouselController = carouselController != null
            ? carouselController as AppCarouselControllerImpl
            : AppCarouselController() as AppCarouselControllerImpl,
        super(key: key);

  /// The on demand item builder constructor
  AppCarouselSlider.builder(
  ...
  @override
  AppCarouselSliderState createState() =>
      // ignore: no_logic_in_create_state
      AppCarouselSliderState(_carouselController);
}

class AppCarouselSliderState extends State<AppCarouselSlider>
    with TickerProviderStateMixin {
  final AppCarouselControllerImpl carouselController;
  Timer? timer;

  AppCarouselOptions get options => widget.options;

  AppCarouselState? carouselState;
  ...
  AppCarouselSliderState(this.carouselController);
  ...
  @override
  void didUpdateWidget(AppCarouselSlider oldWidget) {
  ...
  void initState() {
    super.initState();
    carouselState =
        AppCarouselState(options, clearTimer, resumeTimer, changeMode);

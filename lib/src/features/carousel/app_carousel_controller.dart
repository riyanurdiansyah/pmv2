...
import 'app_carousel_slider.dart';
import 'app_carousel_state.dart';

abstract class AppCarouselController {
  bool get ready;
  ...
  factory AppCarouselController() => AppCarouselControllerImpl();
}

class AppCarouselControllerImpl implements AppCarouselController {
  final Completer<void> _readyCompleter = Completer<void>();

  AppCarouselState? _state;

  set state(AppCarouselState? state) {
    _state = state;
